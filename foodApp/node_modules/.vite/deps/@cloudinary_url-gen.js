...
var CloudConfig = class extends BaseConfig_default {
...
var Region = { ocr: ocr2, faces, custom };
...
var number_pattern2 = "([0-9]*)\\.([0-9]+)|([0-9]+)";
var offset_any_pattern2 = "(" + number_pattern2 + ")([%pP])?";
var RangeParam = class extends Param {
  constructor(name2, shortName, process2 = RangeParam.norm_range_value) {
    super(name2, shortName, process2);
  }
...
var Transformation2 = class extends TransformationBase {
  constructor(options) {
    super(options);
  }
  static new(options) {
